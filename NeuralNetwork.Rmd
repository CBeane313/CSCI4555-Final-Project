...
steamdata$primary_genre_number <- factor(as.numeric(steamdata$primary_genre_number)) 
steamdata$engine_number <- factor(steamdata$engine)
steamdata$engine_number <- factor(as.numeric(steamdata$engine_number))
#steamdata$engine_number_onehot <- to_categorical(as.numeric(steamdata$engine_number, num_classes =  83))
#genre_onehot <- to_categorical(as.numeric(steamdata$primary_genre_number, num_classes = 24))
